  ...
  return <section id="publications" className="section-padding">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          {publications.map((pub, index) => <motion.article key={pub.title} initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          delay: index * 0.1
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <a href={pub.link} className="flex-shrink-0 p-2 text-muted-foreground hover:text-foreground transition-colors" target="_blank" rel="noopener noreferrer">
        ...
        delay: 0.3
          ...
          <a target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-accent hover:text-accent/80 font-medium transition-colors" href="https://scholar.google.com/citations?user=RfOb7j8AAAAJ&hl=en">
